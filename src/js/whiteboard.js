...
const whiteboard = {
    ...
    loadWhiteboard: function (whiteboardContainer, newSettings) {
        ...
        let whiteboardWrapperDOM = document.getElementById("whiteboardWrapper");
        let whiteboardContainerDOM = document.getElementById("whiteboardContainer");

        let paz = new PanAndZoom(whiteboardWrapperDOM, whiteboardContainerDOM, mouseOverlay, _this);
        paz.addZoomListener();
        paz.addPanListener();
